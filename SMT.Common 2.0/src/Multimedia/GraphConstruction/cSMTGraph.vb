...
#Region "FILTERS:MICROSOFT:DVD_NAV"
        ...
        Public Function AddDVDNav() As Boolean
            Try
                ...
                HR = DVDCtrl.SetOption(DvdOptionFlag_Win7.DVD_EnableLoggingEvents, False)
        ...
        Public Function InitializeDVDNavigator(ByRef Languages As cLanguages, ByRef Countries As cCountries, ByVal NavigatorSetup As sNavigatorSetup) As Boolean
            Try
                ...
                If Not KO_IKeystoneMixer Is Nothing Then
...
#Region "FILTERS:MICROSOFT:VMR9"
        ...
        Public VMR9_In_1, VMR9_In_2, VMR9_In_3, VMR9_In_4, VMR9_In_5 As IPin
        ...
        Public Function AddVMR9(ByVal NumberOfPins As Short) As Boolean
            Try
                ...
                If NumberOfPins > 1 Then
                    For i As Integer = 1 To NumberOfPins - 1
                        Select Case i
                            Case 1
                                HR = VMR9.FindPin("VMR Input1", Me.VMR9_In_2)
                                If HR < 0 Then Marshal.ThrowExceptionForHR(HR)
                            Case 2
                                HR = VMR9.FindPin("VMR Input2", Me.VMR9_In_3)
                                If HR < 0 Then Marshal.ThrowExceptionForHR(HR)
                            Case 3
                                HR = VMR9.FindPin("VMR Input3", Me.VMR9_In_4)
                                If HR < 0 Then Marshal.ThrowExceptionForHR(HR)
                            Case 4
                                HR = VMR9.FindPin("VMR Input4", Me.VMR9_In_5)
                                If HR < 0 Then Marshal.ThrowExceptionForHR(HR)
                        End Select
                    Next
                End If
