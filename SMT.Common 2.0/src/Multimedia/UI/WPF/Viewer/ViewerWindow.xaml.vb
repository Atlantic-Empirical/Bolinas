...
#Region "UI EVENTS"
        ...
        Private Sub Viewer_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
            Try
                'If Player Is Nothing Then MsgBox("player is nothing")
                'If Player.Graph Is Nothing Then MsgBox("player.graph is nothing")
                'If Player.Graph.VideoWin Is Nothing Then MsgBox("player.graph.videowin is nothing")
                'If ViewerHost Is Nothing Then MsgBox("viewerhost is nothing")
