...
Public Class Bolinas_SplashScreen
    ...
    Private Sub Avacuno_SplashScreen_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
        If e.KeyCode = Forms.Keys.M Then
            RunApp(True, True)
        Else
            RunApp(True, False)
        End If
    ...
    Private Sub WriteVersionOnBitmap(ByRef BM As Bitmap)
        Try
            Dim str As String = "v" & My.Application.Info.Version.Major & "." & My.Application.Info.Version.Minor & "." & My.Application.Info.Version.Build
